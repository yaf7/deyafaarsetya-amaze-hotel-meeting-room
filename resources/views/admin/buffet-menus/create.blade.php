...
@section('page-title', 'Tambah Menu Buffet')
...
<div class="mb-6">
    <div class="flex items-center gap-3 mb-2">
        ...
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Tambah Menu Buffet</h1>
            <p class="text-gray-500 text-sm">Isi form untuk menambah menu buffet baru</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
    <form action="{{ route('admin.buffet-menus.store') }}" method="POST">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       placeholder="Contoh: Sup Brokoli Jamur"
                       required>
                @error('name')
            ...
            <div>
                ...
                <select name="category" 
                    ...
                    <option value="fritter" {{ old('category') == 'fritter' ? 'selected' : '' }}>Fritter</option>
                </select>
                @error('category')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
